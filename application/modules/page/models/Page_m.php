...
class Page_m extends MY_Model {
    ...
    public function save($data, $id = NULL) {
        ...
        if ($id === NULL || $id === 0 || $id === "") {
            ...
            $list = array('title' => $data['title'], 'slug' => $data['slug'], 'body' => $data['body'], 'parent_id' => $data['parent_id'],'p_status'=>$data['p_status']);
            $this->db->set($data);
