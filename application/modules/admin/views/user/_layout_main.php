<?php $this->load->view('admin/components/page_head');?>
  ...
  <div class="container-fluid">
	...
	<li ><a href="<?php echo base_url('admin/page/order');?>">  Page Order </a></li>
        ...
        <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Widget<strong class="caret"></strong></a>
        ...
        <li class="dropdown">
 		    ...
 		    <li> <a href="<?php echo base_url('admin/gallery_photo');?>">Photo</a> </li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#"> <a href="<?php echo base_url('admin/user/logout'); ?>"> <span class=" glyphicon glyphicon-off" aria-hidden="true"></span>  Logout </a></li>
