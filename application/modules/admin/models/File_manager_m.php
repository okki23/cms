...
class File_manager_m extends MY_Model {
    ...
    public function save($data, $id = NULL) {
        ...
        if ($id === NULL || $id === 0 || $id === "") {
            ...
            $id = $filter($id);
            $list = array('caption_a'=>$data['caption_a'],'caption_b'=>$data['caption_b'],'foto'=>$data['filename'],'order'=>$data['order']);
    ...
    public function get_new() {
        ...
        $file_manager->id = ''; 
        $file_manager->caption_a = '';
        $file_manager->caption_b = '';
        $file_manager->foto = '';
        $file_manager->order = '';
